export function leftOnAnimation() {
  ...
  document.getElementById("Linkedin").style.zIndex = '2';
  document.getElementById("Github").style.zIndex = '1';
...
export function leftOffAnimation() {
  ...
  document.getElementById("Github").style.transitionDuration = '1s';
  document.getElementById("Linkedin").style.zIndex = '1';
  document.getElementById("Github").style.zIndex = '2';
}
